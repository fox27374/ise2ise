...
func TestApplyCreatesOnlyWhatPreflightAllowed(t *testing.T) {
	...
	res, err := ApplyImport(c, rep, "test-passphrase-1234567890", "", map[string]bool{}, false, false, quiet)
	if err != nil {
	...
	rep2, err := Preflight(c, b, nil, false)
	if err != nil {
	...
	res2, err := ApplyImport(c, rep2, "test-passphrase-1234567890", "", map[string]bool{}, false, false, quiet)
	if err != nil {
